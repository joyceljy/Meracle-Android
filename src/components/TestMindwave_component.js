                ...
                return (
                    ...
                    <View style={styles.Viewstyle}>
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => this.setState({ cdName:text })}
                            value={this.state.cdName}
                        />
                        <TouchableOpacity onPress={() => this.setState({ StartBtn: true })}>
                            <Text style={styles.topbarText}>開始收腦波</Text>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={() => this.props.End()}>
                            <Text style={styles.topbarText}>結束收腦波</Text>
                        </TouchableOpacity>
                    </View>
