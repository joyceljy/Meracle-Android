                        ...
                        <View style={styles.cardsize}>
                            <Card style={{
                                ...
                                <CardItem button>
                                    <Body style={{ flexDirection: 'row', }}>
                                        <View style={this.kidlist(i)}>
                                            <Image source={require('../images/avatar_girl.png')} style={{ left: 1, top: 3.5 }}></Image>
                                        </View>
                                        <Text style={styles.kidcardname}>
                                            {kidlistpre[key][i].CdName}
                                        </Text>
                        ...
                        <View style={styles.cardsize}>
                            <Card style={{
                                ...
                                <CardItem button >
                                    <Body style={{ flexDirection: 'row', }}>
                                        <View style={this.kidlist(i)}>
                                            <Image source={{ uri: imgurl }} style={{ left: 1.9, top: 3.5, width: 40, height: 40, borderRadius: 50 }}></Image>
                                        </View>
                                        <Text style={styles.kidcardname}>
                                            {kidlistpre[key][i].CdName}
                                        </Text>
                        ...
                        <View style={styles.cardsize}>
                            <Card style={{
                                ...
                                <CardItem button>
                                    <Body style={{ flexDirection: 'row', }}>
                                        <View style={this.kidlist(i)}>
                                            <Image source={{ uri: imgurl }} style={{ left: 1, top: 3.5, width: 40, height: 40, borderRadius: 50 }}></Image>
                                        </View>
                                        <Text style={styles.kidcardname}>
                                            {kidlistpre[key][i].CdName}
                                        </Text>
